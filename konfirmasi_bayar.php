...
<html lang="en">
  ...
  <body>
    ...
    <!-- ISIAN PERTAMA-->
    <div id="isianform" style="width: 400px; height: 600px; margin-left: 30px; float:left; margin-top: -21px;">
    ...
    <br><br>
      <div class="form-group col-md-6">
        <div class="card" style="width: 17rem;">
          ...
          <div class="card-body">
              <h4>Transformer </h4>
              <p> Tunjungan - Studio 1  <br>
                  Date: <b>Rabu, 15 April 2020</b><br>
                  Time: <b>15.30</b><br>
                  Snacks: <b>Without Snacks</b> <br>
                  Row: <b>1</b> Seat: <b>A</b> <br>
                  <b>Rp. 50.0000</b>
              </p>
              <form>
...
<html lang="en">
  ...
  <body>
    ...
    <br><br>
      <div class="form-group col-md-6">
        <div class="card" style="width: 17rem;">
          <img class="card-img-top" src="transformer.jpg" alt="Card image cap" style="width: 260px; height: 300px; margin-left: 6px;"> 
          <div class="card-body">
              <h4>Transformer </h4>
              <p> Tunjungan - Studio 1  <br>
                  Rabu, 15 April 2020   <br>
                  <b>Seat 1A</b>
              </p>
              <form>
              <div class="form-group">
